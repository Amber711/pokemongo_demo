...
def search_point(cell_id, api):
	...
	# print get maps object
        #only needs a cell info on pokemon
	cell_ids = [ cell_id ]
	# Every cell_id has its own timestamp which indicates that if user has ever seen this cell.
    	timestamps = [0]
...
if __name__ == "__main__":
	...
	scan_area(40.7665138,40.7473342,-74.0003176, -73.487958, api)
